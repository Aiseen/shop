...
# from applications.cart.tasks import celery_order_mail


class OrderSerializer(serializers.ModelSerializer):
    customer = serializers.ReadOnlyField(source='customer.email')

    class Meta: #если наследуемся от serializers
        model = Order
        fields = '__all__'
    ...
    def create(self, validated_data):
        ...
        # celery_order_mail.delay(email=user.email,body=validated_data['info'])
        pass
